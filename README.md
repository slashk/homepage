...
- [This version](https://github.com/slashk/homepage) wants to be your self-hosted homepage, monitoring almost _any and all_ of your _stuff_ (self-hosted or not). We want more widgets and services than the main repo provides.
...
Feel free to add a PR for new widgets -- we like new widgets.
